...
admin.site.register(models.EvidenceGroup)
admin.site.register(models.EvidenceStage)
admin.site.register(models.EvidenceStatus)
admin.site.register(models.EvidenceType)